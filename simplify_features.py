...
if __name__ == '__main__':
    ...
    feature_cover_term_map= pd.read_csv(constants.feature_map)
    ...
    output_segment_keyword_matrix = constants.segment_keyword_matrix
    output_feature_index = constants.segment_keyword_matrix_feature_index
