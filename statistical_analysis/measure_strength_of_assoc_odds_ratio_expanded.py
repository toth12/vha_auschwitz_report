...
if __name__ == '__main__':
    ...
    data = np.load(constants.segment_keyword_matrix_original.replace('.txt', '.npy'), 
                  allow_pickle=True)

    # Read the column index (index terms) of the matrix above
    features_df = pd.read_csv(constants.segment_keyword_matrix_original_feature_index)
    ...
    output_directory = constants.output_data_report_statistical_analysis_expanded
